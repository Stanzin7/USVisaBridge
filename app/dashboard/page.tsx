  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Your visa slot alerts and recent reports</p>
      </div>
                ...
                <div key={report.id} className="border-b pb-4 last:border-0">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{report.consulate}</p>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-semibold">
                        {alert.slot_reports?.visa_type} - {alert.slot_reports?.consulate}
                      </p>
                      <p className="text-sm text-gray-500">
